...
export default function MacOsDesktop() {
  ...
  return (
    <div className="h-screen w-full overflow-hidden flex flex-col font-sans text-white relative">
      ...
      {/* 3. Dock Inferior */}
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-[#28394a]/50 backdrop-blur-3xl backdrop-saturate-150 border border-white/20 shadow-[0_10px_30px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.2)] rounded-[32px] p-2.5 flex items-center -space-x-1 z-[100]">
